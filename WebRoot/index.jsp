...
<html>
  ...
  <body>
  	<p align="center" >股票代码：<input type="text" align="middle" size="5"/>
    ...
    <script src="js/echarts.js"></script>
     <script type="text/javascript">
        ...
        require(
            ...
            function (ec) {
            	var myChartk = ec.init(document.getElementById('kmap'));
            	myChartk.setOption({
            	    title : {
            	        text: '2013年上半年上证指数'
            	    },
                ...
                var myChartline = ec.init(document.getElementById('linemap'));
                var option = {
                	    title : {
                	        text: '未来一周气温变化',
                	        subtext: '纯属虚构'
